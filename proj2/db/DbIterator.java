...
public interface DbIterator extends Serializable{
    ...
    /** Returns true if the iterator has more Rows.
     * @return true f the iterator has more Rows.
     * @throws IllegalStateException If the iterator has not been opened
     */
    public boolean hasNext() throws DbException, TransactionAbortedException;

    /**
     * Returns the next Row from the operator (typically implementing by reading
     ...
     * @return the RowDesc associated with this DbIterator.
     */
