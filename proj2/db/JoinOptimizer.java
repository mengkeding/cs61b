...
//
//        try {
//            t1id = plan1.getRowDesc().columnNameToIndex(lj.f1QuantifiedName);
//        } catch (NoSuchElementException e) {
//            throw new ParsingException("Unknown column " + lj.f1QuantifiedName);
//        }
//
...
//        } else {
//            try {
//                t2id = plan2.getRowDesc().columnNameToIndex(
//                        lj.f2QuantifiedName);
//            } catch (NoSuchElementException e) {
//                throw new ParsingException("Unknown column "
//                        + lj.f2QuantifiedName);
//            }
//        }
//
...
//            String table1Alias, String table2Alias, String column1PureName,
//            String column2PureName, int card1, int card2, boolean t1pkey,
...
//
//    /**
//     * Return true if column is a primary key of the specified table, false
//     * otherwise
//     *
//     * @param tableAlias
//     *            The alias of the table in the query
//     * @param column
//     *            The pure name of the column
//     */
//    private boolean isPkey(String tableAlias, String column) {
//        int tid1 = p.getTableId(tableAlias);
//        String pkey1 = Database.getCatalog().getPrimaryKey(tid1);
//
//        return pkey1.equals(column);
//    }
//
//    /**
//     * Return true if a primary key column is joined by one of the joins in
//     * joinlist
//     */
